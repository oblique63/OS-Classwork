...
\includesource{c}{unix.c}

%\filename{Deadlocked Version}
%\includesource{c}{unix_deadlock.c}


\append{III} {Unix Output}

\includeoutput{output/unix.txt}

%\filename{Deadlocked Version}
%\includeoutput{output/unix_deadlock.txt}


%----{ WINDOWS }-------------------------------------------------------------------------
\append{IV} {Windows Source Code}

\includesource{c}{win.c}

%\filename{Deadlocked Version}
%\includesource{c}{win_deadlock.c}


\append{V} {Windows Output}

\includeoutput{output/win.txt}

%\filename{Deadlocked Version}
%\includeoutput{output/win_deadlock.txt}
